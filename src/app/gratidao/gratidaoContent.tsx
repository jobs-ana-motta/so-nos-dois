...
export default function GratidaoContent() {
  ...
  const mensagem = encodeURIComponent(
    `Olá! Quero ativar minha página romântica: "id do pedido: ${id}"`
  );
        ...
        <div className="flex items-center flex-col p-4 bg-[#1f1f1f] rounded shadow-md gap-4 md:min-w-[768px]">
          ...
          <div className="max-w-6/8 md:max-w-5/8 text-center flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              {!casal.paid ? (
                <a
                  href={`https://api.whatsapp.com/send?phone=5543999274825&text=${mensagem}`}
                  target="_blank"
